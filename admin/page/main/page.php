...
if(isset($_GET['mp'])){
	...
	?>
	<div id="m-border">
	<div class="title-mcontent"><img src='./misc/mm.png' width='9'> <?php print $row['bnama'] ?></div>
	<?php if ($row['bbes']==1){ ?><div class="best"></div> <?php } ?>
	<table border="0" cellpadding="0" cellspacing="0" class="imgleft">
		<tr>
			<td rowspan='4'><?php print "<img src=./images/$row[bimg] title=$row[bnama] height='80'class='m-img'>";?> </td>
			<td>Harga :</td>
		</tr>
