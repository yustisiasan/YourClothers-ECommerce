<?PHP
	...
	if (!empty($_GET['view']) && $_GET['view']<>'') {
		...
		$qry=mysql_query("SELECT * FROM users WHERE users.unama='$unama'", $dbconn);
...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td rowspan='7'><?php print "<img src=./images/$row[uimg] alt='Foto'.$row[unama] height='120'>";?> </td>
	...
	<?php
	print "<a href='./?n=user_ed&&view=$row[unama]'><button name='submit' class='btn'>&nbsp;&nbsp;Edit&nbsp;&nbsp;</button></a>";
	}
	else {
	?>
