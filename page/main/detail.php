...
<div class="title-content">Detail Produk</div>
<div id="border">
	<?php
		$bid=$_GET['bid'];
		...
		if ($total>0) {
		    $qry=mysql_query("SELECT a.* FROM barang a WHERE a.bid='$bid'",$dbconn);
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan='2' rowspan='7' width='150'><?php print "<div class='m-img'><a href='./admin/images/$row[bimg]'><img src='./admin/images/$row[bimg]' title='$row[bnama]' height='180'></a></div>";?></td>
					<td><h3></h3></td>
				</tr>
				<tr><td><h3>Harga :</h3></td>					</tr>
				<tr><td><h3><?php print "Rp. ".number_format($row['bharga']) ?> </h3></td></tr>
				<tr><td colspan='2'>&nbsp;</td></tr>
				<tr><td>Ukuran :&nbsp;<?php print $row['bukuran'] ?></td></tr>
				<tr><td align='justify'><h3>Catatan :</h3><?php print $row['bcatatan'] ?></td></tr>
